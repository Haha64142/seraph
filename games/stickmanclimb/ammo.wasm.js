...
var Ammo = (function() {
    ...
    return (
        function(Ammo) {
            ...
            var ha = "",
                ja, ka, la, ma;
            if (ea) ha = da ? require("path").dirname(ha) + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" : __dirname + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/", ja = function(a, c) {
                la || (la = require("fs"));
                ma || (ma = require("path"));
                a = ma.normalize(a);
                ...
                assert(a.buffer);
                return a
            }, 1 < process.argv.length && process.argv[1].replace(/\\/g, "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"), process.argv.slice(2), process.on("uncaughtException", function(a) {
                throw a;
                ...
                ha.substr(0, ha.lastIndexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") + 1) : "", ja = function(a) {
