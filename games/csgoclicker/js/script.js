...
function drawItem(array, rarity) {
    ...
    var img = array[2] + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/70fx70f";
...
function drawInventory() {
  ...
  for (var i = 0; i < keys.length; i++) {
    ...
    var img = item["img"] + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/70fx70f";
...
function caseInfo() {
  $('#caseDisplayImage').attr("src", operationCases[currentCase]["img"] + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/240fx182f");
...
function update() {
  ...
  $('#inventorySpace').html(inventoryCurrent + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + inventoryMax);
}
...
function caseModalDraw(name, img) {
  ...
  $("#modalImage").attr("src", img + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/360fx360f");
...
function drawJackpotSwapItem(name, price, img, id) {
      ...
      var img = img + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/70fx70f";
...
function updateSwapInfo() {
  ...
  $(".jackpotRightSkinsTotal").html(swapSkins + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + maxSwapSkins);
}
