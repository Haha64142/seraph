...
, function(n, e, t) {
    ...
    e.a = r;
    var m, p, g, w, v, y, b = t(10), x = t.n(b), S = t(0), L = "image", k = 0, E = !1, I = S.a.screenshotsVersion ? "?v".concat(S.a.screenshotsVersion) : "", C = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")), T = window.location.hostname.endsWith("game-cdn.poki.com") || window.location.hostname.endsWith(".poki-gdn.com"), B = T ? "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/cdn-cgi/image/f=auto,quality=78".concat(C, "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") : "";
    ...
    n.exports = function(n) {
        ...
        return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, e) {
            ...
            if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i))
                return n;
            var r;
            return r = 0 === i.indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//") ? i : 0 === i.indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") ? t + i : o + i.replace(/^\.\//, ""),
