...
var GameArchiveLoader = {
    ...
    downloadPiece: function(file, index) {
        ...
        var total = 0;
        var downloaded = 0;
        var url = this._archiveLocationFilter('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/' + piece.name);
    ...
    **/
    runApp: function(appCanvasId, extra_params) {
        ...
        if (Module.hasWebGLSupport()) {
            ...
            GameArchiveLoader.loadArchiveDescription('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/archive_files.json');
        } else {
