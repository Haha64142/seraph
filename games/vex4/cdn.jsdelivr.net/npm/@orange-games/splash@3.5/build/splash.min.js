...
! function(a) {
    ...
    var c = function() {
        ...
        return c.setSiteLock = function(a) { c.siteLocks = a }, c.preloadImages = function(b) {
            var d;
            switch (a.Utils.isOnDevice(b) || c.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/orange-games-splash/assets/"), a.Utils.getBrandingDomain()) {
            ...
            var g, h, i = a.Utils.getSourceSite(),
                j = a.Utils.isOnDevice(d) ? "https://" : "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//";
            ...
            h = window.open(g + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/?utm_source=" + i + "&utm_medium=html5&utm_term=" + e + "&utm_content=" + k + "&utm_campaign=Gamedistribution", "_blank"), h && h.focus && h.focus()
...
! function(a) {
    var b = function() {
        ...
        return a.initialize = function(b, c, d, e) {
            ...
            }(window, document, "script", "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//video-static.vooxe.com/libs/gd/gd.js", "gdPlayer", void 0, void 0), gdPlayer(i)
    ...
    ! function(b) {
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.createItems = function() {
                ...
                a.Utils.isOnDevice(b) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//" + window.location.host + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/orange-games-splash/assets/"), a.Utils.isTc() || (b.load.crossOrigin = "anonymous"), b.load.image("close_btn", a.Utils.ASSET_LOCATION + "images/close_btn.png");
    ...
    ! function(b) {
        var c = function(b) {
            function c(c, d) {
                ...
                var f = a.Utils.isOnDevice(c) ? "https://" : "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//";
    ...
    ! function(b) {
        var c = function(c) {
            ...
            return __extends(d, c), d.prototype.init = function(b) {
                ...
                a.Utils.isOnDevice(this.game) || a.Branding.isAirfi() ? a.Utils.ASSET_LOCATION = "assets/" : a.Utils.isTc() ? a.Utils.ASSET_LOCATION = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/repository/download/Fabrique_FunnyGamesSplash/.lastSuccessful/build/assets/" : "fbrq.io" === a.Utils.getSourceSite(!0) && (a.Utils.ASSET_LOCATION = "https://" + window.location.host + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/@orange-games/splash/assets/"), a.Utils.registerAudioUnlocker(this.game)
...
! function(a) {
    var b = function() {
        ...
        return b.getSourceSite = function(c) {
            ...
            a.Branding.isSpil() && (d = b.getReferrer(d)), d = d.indexOf("://") > -1 ? d.split("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")[2] : d.split("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")[0], d = d.split(":")[0];
    ...
    b.ASSET_LOCATION = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/cdn.fbrq/@orange-games/splash/assets/", a.Utils = b
}(Fabrique || (Fabrique = {}));
        ...
        return b.prototype.init = function(c, d, e, f) {
            ...
            if (!(c.length < 1)) {
                var f = CryptoJS.HmacSHA256(c, this.secretKey),
                    ...
                    h = b.API_URL + this.gameKey + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + d;
