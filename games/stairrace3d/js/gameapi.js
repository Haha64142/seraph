	...
	module.prototype.init = function() {
		...
		switch (M.provider) {
			...
			case "dfp":
				...
				M.dfp_ad_unit_code =
					"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/37336410/InGameInterstitial//" + self.config.aid + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//d0";
	...
	module.prototype.showAlsoLikedApps = function(callback, force) {
		...
		function listApps(apps) {
			...
			apps.slice(0, 4).forEach(function(app) {
				...
				var parts = app.id.split("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/");
				var gameID = parts[1];
	...
	module.prototype.init = function() {
		...
		switch (M.provider) {
			...
			case "dfp":
				...
				//M.dfp_ad_unit_code =
				//	"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/41567730/InGameInterstitial//" + self.config.aid + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//d0";
...
fg_api.prototype.rewardedadsModule = function() {
	...
	module.prototype.init = function() {
        ...
        if (urlParams.fg_env && (urlParams.fg_env == "dev" || urlParams.fg_env == "staging")) {
            M.dfp_ad_unit_code = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/6062/sanghan_rweb_ad_unit"
        } else {
            M.dfp_ad_unit_code = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/37336410/InGameInterstitial//" + self.config.aid + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//d0";
        }
...
fg_api.prototype.getAbsolutePath = function(relativePath) {
	var absolutePath =
		document.location.protocol + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//" + document.location.pathname;
	...
	if (relativePath.startsWith("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")) {
		relativePath = relativePath.substr(1);
	}

	return (
		absolutePath.substr(0, absolutePath.lastIndexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") + 1) + relativePath
	);
};
...
fg_api.prototype.socketModule = function () {
    ...
    module.prototype.init = function () {
        (function (d, s, id) {
            ...
            js.id = id;
            js.src =
                "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//cdnjs.cloudflare.com/ajax/libs/socket.io/4.0.1/socket.io.js";
...
fg_api.prototype.screenshotModule = function() {
	...
	function uploadScreenshot(imageSrc) {
		...
		faZepto.ajax({
			type: "POST",
			url: self.config.urlRoot + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/services/upload/images",
			data: {
...
fg_api.prototype.iframeModule = function() {
	...
	iframePrototype.show = function(url, options) {
		...
		if (url.length) {
			if (url.indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") === 0) {
...
fg_api.prototype.flashModule = function() {
	...
	flashPrototype.init = function() {
			...
			M.callbackFn = function() {
				if (swfobject.getFlashPlayerVersion().major === 0) {
					...
					fgGetFlash = self.createElement("img", {
						src: "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/flashgames/swfobject/getFlash.png",
		...
		window.famobi_gameJS.unshift(
			"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/flashgames/swfobject/swfobject.js",
			function() {
				swfobject.embedSWF(
					M.swfUrl,
					M.replaceElemId,
...
fg_api.prototype.videoModule = function() {
	...
	function module() {
		...
		this.videoUrl = self.config.urlRoot + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/services/video";
	}
	...
	module.prototype.trackEvent = function(eventName) {
		...
		return faZepto.post(
			M.videoUrl + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/videos/" + self.config.video.id + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/track",
			postData
		);
	};
	...
	module.prototype.init = function() {
		...
		switch (M.provider) {
			default:
				...
				M.dfp_ad_unit_code = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/37336410/InVideo//" + self.config.aid;
				break;
		}
	...
	function loadStylesheet() {
		return new Promise(function (resolve) {
			...
			newStylesheet.setAttribute(
				"href",
				self.config.assetsPath + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/css/play.css"
			);
