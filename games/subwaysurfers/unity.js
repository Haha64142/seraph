! function(n) {"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/
    function e(o) {
    ...
    var m, p, g, w, v, y, b = t(10),
        ...
        C = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")),
        T = window.location.hostname.endsWith("game-cdn.poki.com") || window.location.hostname.endsWith(".poki-gdn.com"),
        B = T ? "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/cdn-cgi/image/f=auto,quality=78".concat(C, "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") : "";
    ...
    function o(n, e) {
        ...
        if (e && "function" == typeof btoa) {
            ...
            return [t].concat(o.sources.map(function(n) {
                return "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/*# sourceURL=" + o.sourceRoot + n + " */"
            })).concat([r]).join("\n")
        }
        return [t].join("\n")
    }
    ...
    function i(n) {
        return "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(n)))) + " */"
    }
    ...
    n.exports = function(n) {
        ...
        var t = e.protocol + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//" + e.host,
            o = t + e.pathname.replace(/\/[^\/]*$/, "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/");
        return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, e) {
            ...
            var r;
            return r = 0 === i.indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//") ? i : 0 === i.indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") ? t + i : o + i.replace(/^\.\//, ""), "url(" + JSON.stringify(r) + ")"
        })
    }
}, function(n, e, t) {
    "use strict";
