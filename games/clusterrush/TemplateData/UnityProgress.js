function UnityProgress (dom) {
  var root_path = 'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/TemplateData';
  this.progress = 0.0;
  this.message = "";
  this.dom = dom;
  ...
  progressFrame.src = root_path + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/loadingbar.png"; 
  ...
  progressBar.src = root_path + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/fullbar.png"; 
  ...
  this.SetMessage = function (message) {
    if (message == "Loading WebGL Player, Please wait...") {
      message += '<img src="' + root_path + 'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/gears.gif" />'
