...
! function(b, c) {
    ...
    function Gc(b) {
        return b.type = (null !== b.getAttribute("type")) + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + b.type, b
    }
    ...
    j.extend({
        ...
        ajax: function(c, d) {
            ...
            if (D.promise(L), t.url = ((c || t.url || Ka.href) + "").replace(Fd, Ka.protocol + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//"), t.type = d.method || d.type || t.method || t.type, t.dataTypes = (t.dataType || "*").toLowerCase().match(V) || [""], null == t.crossDomain) {
                p = A.createElement("a");
                try {
                    p.href = t.url, p.href = p.href, t.crossDomain = yb.protocol + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//" + yb.host != p.protocol + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main//" + p.host
                } catch (H) {
                    t.crossDomain = !0
                }
            }
...
jukebox.Player.prototype = {
    defaults: {
        ...
        autoplay: !1,
        spritemap: {},
        flashMediaElement: "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/swf/FlashMediaElement.swf",
        timeout: 1E3
    },
    ...
    b.prototype = {
        ...
        _setupCodecs: function() {
            ...
            var f = d.canPlayType("audio/mpeg;").replace(/^no$/, ""),
                ...
                l = l && 33 > parseInt(l[0].split("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")[1], 10);
            b._codecs = {
...
(function(b) {
    ...
    b.ig = {
        ...
        _loadScript: function(b, c) {
            ...
            ig._waitForOnload++;
            var d = ig.prefix + ig.lib + b.replace(/\./g, "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") + ".js" + ig.nocache,
                e = ig.$new("script");
