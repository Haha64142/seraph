                                ...
                                if (e.sdkImaError) l.dispatchEvent(c.ads.displayError, {
                                    ...
                                    var i = function(t, n) {
                                        ...
                                        if ((v() || b() || ["970x250", "300x250", "728x90", "160x600"].includes(t)) && (!v() && !b() || ["320x50"].includes(t))) {
                                            ...
                                            return {
                                                id: mt.GetIsPokiIFrame() ? i + "_ingame_" + t + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + r + "_" + i + "_ingame_" + t : "external_" + i + "_display_ingame/external_" + i + "_ingame_" + t,
                                                size: e
                                            }
                                        }
                                    }(n, e.debug);
