...
async function GetMainPageUrl()
{
	...
	for (const c of allClients)
	{
		...
		if (url && url !== "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/")		// ./ is also implicitly cached so don't bother returning that
		{
			...
			if (url.startsWith("?"))
				url = "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + url;
...
async function UpdateCheck(isFirst)
{
	try {
		...
		fileList.unshift("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/");
