...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		M.castSpell=function(spell,obj)
		{
			...
			Math.seedrandom(Game.seed+'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/'+M.spellsCastTotal);
	...
	{
		//run each draw frame
		M.magicBarTextL.innerHTML=Math.min(Math.floor(M.magicM),Beautify(M.magic))+'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/'+Beautify(Math.floor(M.magicM))+(M.magic<M.magicM?(' (+'+Beautify((M.magicPS||0)*Game.fps,2)+'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/s)'):'');
