	...
	M.draw=function()
	{
		...
		if (Game.drawT%2==0 && M.toRedraw>0 && M.graph && M.graphCtx)
		{
			...
			for (var i=0;i<M.goodsById.length;i++)
			{
				...
				me.symbolNumL.innerHTML=val+''+(val==Math.floor(val)?'.00':(val*10)==Math.floor(val*10)?'0':'')+'%'https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/*+', '+['stable','slow rise','slow fall','fast rise','fast fall','chaotic'][me.mode]*/;
				...
				me.stockMaxL.innerHTML='https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/'+Beautify(M.getGoodMaxStock(me));
