var unpackage = (function() {
  ...
  const getContainingFolder = (name) => {
    const parts = name.split('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/');
    parts.pop();
    return parts.join('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/');
  };
  ...
  const unpackage = async (blob) => {
    ...
    const dataURIMatch = (
      ...
      text.match(/window\.__PACKAGER__ = {\n    projectData: "([a-zA-Z0-9+/=\-:;,]+)"https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/)
    );
    if (dataURIMatch) {
