...
/***/ "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/src/addons/addons/blocks2image/_runtime_entry.js":
/*!**********************************************************!*\
...
/* harmony import */ var _userscript_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userscript.js */ "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/src/addons/addons/blocks2image/userscript.js");
...
/***/ "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/src/addons/addons/blocks2image/userscript.js":
/*!******************************************************!*\
...
/* harmony default export */ __webpack_exports__["default"] = (async function ({
  ...
  function exportBlock(isExportPNG, block) {
    ...
    svg.querySelectorAll("image").forEach(item => {
      let builtinSvgData = blocksMedia.get(item.getAttribute("xlink:href").substring(item.getAttribute("xlink:href").lastIndexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/") + 1));

      if (builtinSvgData) {
        // replace svg file path (official) to inline svg
        item.setAttribute("xlink:href", builtinSvgData);
      } else if (item.getAttribute("xlink:href").indexOf("https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/static/") === 0) {
        ...
        item.setAttribute("xlink:href", scratchURL + "https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/" + item.getAttribute("xlink:href"));
      }
    });
