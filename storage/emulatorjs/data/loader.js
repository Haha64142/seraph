(async function() {
    const folderPath = (path) => path.substring(0, path.length - path.split('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/').pop().length);
    let scriptPath = (typeof window.EJS_pathtodata === "string") ? window.EJS_pathtodata : folderPath((new URL(document.currentScript.src)).pathname);
    if (!scriptPath.endsWith('https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/')) scriptPath+='https://cdn.jsdelivr.net/gh/Haha64142/seraph@main/';
